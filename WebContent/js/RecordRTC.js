...
function RecordRTC(mediaStream, config) {
    ...
    var returnObject = {
        ...
        save: function(fileName) {
            ...
            //console.log("Hipervinculo " + hyperlink.href);
            var date = new Date();
            if(mediaRecorder.blob.type){
            	hyperlink.download = (fileName || date.getTime() + '.' + mediaRecorder.blob.type.split('/')[1]);
            }else{
...
function MRecordRTC(mediaStream) {
    ...
    this.startRecording = function() {
        ...
        if (this.mediaType.video) {
        	console.log("Media type " + this.mediaType.video);
