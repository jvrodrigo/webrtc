...
public class Helper {
	...
	/**
	 * Metodo para obtener el token de la habitacion de la concatenacion del token
	 * de la habitacion y el usuario "roomToken/userToken"
	 * 
	 * @param token
	 * @return
	 */
	...
	/**
	 * Metodo para obtener el token del usuario de la concatenacion del token de la
	 * habitacion y el usuario "roomToken/userToken"
	 * 
	 * @param token
	 * @return
	 */
	...
	/**
	 * Devuelve un map<string, string> de una petición url con el formato ->
	 * nombre=valor
	 * 
	 * @param query
	 * @return
